...
const NON_PAYABLE = [
  ...
  { tier:"exact", item:"Buds", keywords:"ear bud|cotton bud" },
  ...
  { tier:"exact", item:"Arm Sling", keywords:"arm sling" },
...
function analyse(data){
  ...
  const H=data.header||{};
  const exact=[],review=[];
  for(const l of lines){ const m=bestMatch(l.item); if(!m) continue;
